...
def fitness(population, data, w, h):
	...
	for x in population:
		...
		entropy = shannon_entropy(ans, w, h)
...
# read image
pixel, w, h = imageread('circle.jpg')
...
t = 5.0 													#threshold for image segmentation
final = []
for x in xrange(16):
...
# print 'shannon entropy : ',shannon_entropy( x , w, h) 
# imagewrite(x, w, h)
	# if x % 5 == 0:
